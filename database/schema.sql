...
-- Produits Amazon désactivés pour l'instant (focus goodies + wallpapers ; réactivables quand la vente Amazon démarre).
('GTA VI — Édition Standard (PS5 / Xbox)', 'gta-vi-edition-standard', 'Précommandez Grand Theft Auto VI au meilleur prix. Livraison suivie via notre partenaire.', 'game', 69.99, 'EUR', '/public/assets/img/shop/game-case.png', 'external', 'https://www.amazon.fr/s?k=GTA+VI&tag=vicehubx-21', NULL, 'Amazon', 'Précommande', 0, 0, 10, 'fr'),
('Console Next-Gen — Pack Édition', 'console-next-gen-pack', 'La console nouvelle génération idéale pour profiter de GTA VI en 4K. Pack manette incluse.', 'console', 549.99, 'EUR', '/public/assets/img/shop/console.png', 'external', 'https://www.amazon.fr/s?k=PlayStation+5&tag=vicehubx-21', NULL, 'Amazon', 'Best-seller', 0, 0, 20, 'fr'),
('Manette sans fil Next-Gen', 'manette-sans-fil-next-gen', 'Manette ergonomique compatible next-gen pour des sessions Vice City sans fil.', 'accessory', 74.99, 'EUR', '/public/assets/img/shop/console.png', 'external', 'https://www.amazon.fr/s?k=manette+sans+fil&tag=vicehubx-21', NULL, 'Amazon', NULL, 0, 0, 30, 'fr'),
